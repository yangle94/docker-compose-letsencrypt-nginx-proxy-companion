        ...
        d.fn.dateDropper = function(a) {
            return d(this).each(function() {
                if (d(this).is("input") && "text" == d(this).attr("type")) {
                    ...
                    var w = function() {
                        ...
                        j = function() {
                            f.find(".dd-s-b").each(function(a, e) {
                                ...
                                var l = 0,
                                    u = !1;
                                r.on("mousewheel DOMMouseScroll", function(d) { u = !0, (d.originalEvent.wheelDeltaY < 0 || d.originalEvent.detail > 0) && (l = r.scrollTop() + 100), (d.originalEvent.wheelDeltaY > 0 || d.originalEvent.detail < 0) && (l = r.scrollTop() - 100), r.stop().animate({ scrollTop: l }, 600, "_dd_easing", function() { u = !1 }) }).on("scroll", function() { u || (l = r.scrollTop()) })
                                ...
                                if (o.hasClass("dd-d")) {
                                    ...
                                    o.find("li").click(function() { f.find(".dd-s-b-d").addClass("dd-show") })
                                }
                                if (o.hasClass("dd-y")) {
                                ...
                                o.find(".dd-ul").on("scroll", function() { b() });
                                var h = !1;
                                o.find(".dd-ul").on("mousedown touchstart", function() { h || (h = !0), clearInterval(n), d(window).on("mouseup touchend touchmove", function() { h && (clearInterval(n), n = setTimeout(function() { w(), h = !1 }, 780)) }) }), "Y" == p.format && f.find(".dd-m,.dd-d").hide(), ("m" == p.format || "n" == p.format || "F" == p.format || "M" == p.format) && f.find(".dd-y,.dd-d").hide()
                            }), f.find(".dd-b li").click(function() {
                                return "m" == p.format || "n" == p.format || "F" == p.format || "M" == p.format || "Y" == p.format ? !1 : void f.find(".dd-s-b-s").show()
                            }), f.find(".dd-s-b-s").click(function() { f.find(".dd-s-b").removeClass("dd-show"), f.find(".dd-s-b-s").hide() }), f.find(".dd-s").click(function() { x() }), f.find(".dd-o").click(function() { f.find(".dd-c").addClass("dd-fadeout").removeClass("dd-" + p.init_animation), h = setTimeout(function() { f.hide(), f.find(".dd-c").removeClass("dd-fadeout") }, 400) }), w()
                        },
                    ...
                    c.click(function() { z() }), c.bind("focusin focus", function(d) { d.preventDefault() }), d(window).resize(function() { C() })
                }
            })
        }
    }(jQuery);
